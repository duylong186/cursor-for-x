      ...
      <div className="flex w-full pt-14 h-full">
        ...
        <div className="hidden md:flex w-full">
          ...
          <div className="w-[40%] border-l">
            <ChatInterface content="Cho tôi xem tình hình tổng quan chung của công ty hôm nay" />
          </div>
        </div>
        ...
        <div className="md:hidden w-full">
          {isMobileInfoVisible ? (
            ...
            <ChatInterface className="h-full" content="Cho tôi xem tình hình tổng quan chung của công ty hôm nay" />
          )}
        </div>
      </div>
    </div>
